...
void SettingsDialog::accept()
{
    ...
    QMap<QOnlineTranslator::Language, QLocale::Country> deeplRegions;
    switch (ui->englishRegionComboBox->currentIndex()) {
    case 1:
        deeplRegions[QOnlineTranslator::English] = QLocale::UnitedStates;
        break;
    case 2:
        deeplRegions[QOnlineTranslator::English] = QLocale::UnitedKingdom;
        break;
    default:
        break;
    }
    switch (ui->frenchRegionComboBox->currentIndex()) {
    case 1:
        deeplRegions[QOnlineTranslator::French] = QLocale::France;
        break;
    case 2:
        deeplRegions[QOnlineTranslator::French] = QLocale::Canada;
        break;
    default:
        break;
    }
    switch (ui->germanRegionComboBox->currentIndex()) {
    case 1:
        deeplRegions[QOnlineTranslator::German] = QLocale::Germany;
        break;
    case 2:
        deeplRegions[QOnlineTranslator::German] = QLocale::Switzerland;
        break;
    default:
        break;
    }
    switch (ui->portugueseRegionComboBox->currentIndex()) {
    case 1:
        deeplRegions[QOnlineTranslator::Portuguese] = QLocale::Brazil;
        break;
    case 2:
        deeplRegions[QOnlineTranslator::Portuguese] = QLocale::Portugal;
        break;
    default:
        break;
    }
    if (ui->spanishRegionComboBox->currentIndex() == 1)
        deeplRegions[QOnlineTranslator::Spanish] = QLocale::Mexico; // Representative country for DeepL's "ES-419" (Latin American Spanish)
    settings.setRegions(QOnlineTranslator::DeepLX, deeplRegions); // Shared by DeepLX and DeepLXFree
...
void SettingsDialog::restoreDefaults()
{
    ...
    ui->englishRegionComboBox->setCurrentIndex(0);
    ui->frenchRegionComboBox->setCurrentIndex(0);
    ui->germanRegionComboBox->setCurrentIndex(0);
    ui->portugueseRegionComboBox->setCurrentIndex(0);
    ui->spanishRegionComboBox->setCurrentIndex(0);
...
void SettingsDialog::loadSettings()
{
    ...
    const QMap<QOnlineTranslator::Language, QLocale::Country> deeplRegions = settings.regions(QOnlineTranslator::DeepLX);
    switch (deeplRegions.value(QOnlineTranslator::English)) {
    case QLocale::UnitedStates:
        ui->englishRegionComboBox->setCurrentIndex(1);
        break;
    case QLocale::UnitedKingdom:
        ui->englishRegionComboBox->setCurrentIndex(2);
        break;
    default:
        ui->englishRegionComboBox->setCurrentIndex(0);
        break;
    }
    switch (deeplRegions.value(QOnlineTranslator::French)) {
    case QLocale::France:
        ui->frenchRegionComboBox->setCurrentIndex(1);
        break;
    case QLocale::Canada:
        ui->frenchRegionComboBox->setCurrentIndex(2);
        break;
    default:
        ui->frenchRegionComboBox->setCurrentIndex(0);
        break;
    }
    switch (deeplRegions.value(QOnlineTranslator::German)) {
    case QLocale::Germany:
        ui->germanRegionComboBox->setCurrentIndex(1);
        break;
    case QLocale::Switzerland:
        ui->germanRegionComboBox->setCurrentIndex(2);
        break;
    default:
        ui->germanRegionComboBox->setCurrentIndex(0);
        break;
    }
    switch (deeplRegions.value(QOnlineTranslator::Portuguese)) {
    case QLocale::Brazil:
        ui->portugueseRegionComboBox->setCurrentIndex(1);
        break;
    case QLocale::Portugal:
        ui->portugueseRegionComboBox->setCurrentIndex(2);
        break;
    default:
        ui->portugueseRegionComboBox->setCurrentIndex(0);
        break;
    }
    ui->spanishRegionComboBox->setCurrentIndex(deeplRegions.value(QOnlineTranslator::Spanish) != QLocale::AnyCountry ? 1 : 0);
