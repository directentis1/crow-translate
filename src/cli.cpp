...
void Cli::process(const QCoreApplication &app)
{
    ...
    const QCommandLineOption engine({"e", "engine"}, tr("Specify the translator engine ('google', 'yandex', 'bing', 'libretranslate', 'lingva' or 'deeplx'), Google is used by default."), QStringLiteral("engine"), QStringLiteral("google"));
    ...
    parser.setApplicationDescription(tr("A simple and lightweight translator that allows to translate and speak text using Google, Yandex, Bing, LibreTranslate, Lingva and DeepLX"));
