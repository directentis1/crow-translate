...
void SettingsDialog::onGoogleLanguageSelectionChanged(int languageIndex)
{
    ...
    const QSignalBlocker blocker(ui->googleRegionComboBox); // Rebuilding below must not itself trigger saveGoogleEngineRegion()
...
void SettingsDialog::onDeeplLanguageSelectionChanged(int languageIndex)
{
    ...
    const QSignalBlocker blocker(ui->deeplRegionComboBox); // Rebuilding below must not itself trigger saveDeeplEngineRegion()
